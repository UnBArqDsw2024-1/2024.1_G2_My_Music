...
## Metodologia
O desenvolvimento desta modelagem foi realizada individualmente pelo membro [Vinícius Mendes](https://github.com/yabamiah). No processo de desenvolvimento do diagrama de atividades, foi utilizado como referência o site da [organização do UML](https://www.uml-diagrams.org/)<sup>[1](#referência-bibliográfica)</sup>, e como princial guia para a modelagem o [protótipo de alta fidelidade](https://unbarqdsw2024-1.github.io/2024.1_G2_My_Music/Base/prototipo/)<sup>[2](#referência-bibliográfica)</sup>, na qual através deste artefato é possível traçar atividades que o usuário possa executar.
