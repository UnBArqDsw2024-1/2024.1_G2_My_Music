...
class AlbumModel{
  ...
  AlbumModel({this.id, this.name = "Playlist Name", this.artist = "Artista", this.image = DefaultPlaceholder.image, this.songs});
}
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text.rich(
                ...
                TextSpan(
                  ...
                  children: [
                    TextSpan(text: '${widget.album.songs!.length} songs', style: TextStyle(fontSize: 12, color: Colors.white70,fontWeight: FontWeight.normal)),
                  ]
                ),
              )
            ...
            delegate: SliverChildBuilderDelegate(
              (BuildContext context, int index) {
                return ListTile(
                  ...
                  title: ResponsiveText(text: widget.album.songs!.elementAt(index).name, fontSize: 18,fontColor: Colors.white,fontWeight: FontWeight.w400,),
                  subtitle: ResponsiveText(text: widget.album.songs!.elementAt(index).artists!.first.name, fontSize: 12, fontColor: Colors.white54,fontWeight: FontWeight.w400,),
                  trailing: IconButton(
                    onPressed: (){},
