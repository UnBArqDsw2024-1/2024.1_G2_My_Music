                ...
                children: [
                  ...
                  RawMaterialButton(
                    ...
                    child: ResponsiveContainer(
                      ...
                      child: Center(child: ResponsiveText(text: "Entrar",fontSize: 16,fontWeight: FontWeight.w500,)),
                    )
                  ),
                  ResponsiveContainer(height: 16),
                  Row(
                    children: [
                      Expanded(child: Divider(color: Color(0xff000000),)),
                      ResponsiveText(text: "Ou continue com",fontColor: primaryColor, fontWeight: FontWeight.w700,fontSize: 16,padding: EdgeInsets.symmetric(horizontal: responsiveFigmaWidth(8)),),
                      Expanded(child: Divider(color: Color(0xff000000),)),
                    ],
                  ),
                  ResponsiveContainer(height: 16),
                    ...
                    child: ResponsiveContainer(
                      ...
                      child: Center(child: Row(
                        ...
                        children: const [
                          ...
                          ResponsiveText(text: "Login com o Google",fontSize: 16,fontWeight: FontWeight.w500,),
                        ],
                      )),
                    )
                  ),
                  ...
                  TextButton(onPressed: widget.onTapTogglePage, child: ResponsiveText(text: "Não possui uma conta? Registre-se",fontColor: primaryColor,fontWeight: FontWeight.w700,fontSize: 16,)),
                  ResponsiveContainer(height: 16),
                ],
              ),
            ),
